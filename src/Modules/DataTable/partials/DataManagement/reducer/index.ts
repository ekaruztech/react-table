...
import {ColumnProps, TableFilterAction, TableFilterState} from "../../../types/types";
...
const dataManagementReducer = (state: TableFilterState, action: TableFilterAction): TableFilterState => {
    switch (action.type) {
        case "ADD_FILTER":
