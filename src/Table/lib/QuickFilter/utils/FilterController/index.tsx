...
import { EmptyImage, formatColumnsToKey } from '../../../../../_utils'
import {
  QuickFilterApplyFn,
...
const FilterController: React.FC<FilterControllerProps> = (props) => {
  ...
  const objectifiedColumns = formatColumnsToKey(validColumns)
  ...
  const addFilter = (property: string) => {
    const columnProperty = objectifiedColumns[property]
    const filter = {
      ...columnProperty,
